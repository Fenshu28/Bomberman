 ...
 * @author KCThe
 */
public class MultijugadorFrame extends javax.swing.JFrame {

    /**
     * Creates new form Multijugador
     */
    public MultijugadorFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MultijugadorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MultijugadorFrame().setVisible(true);
            }
        });
    }
